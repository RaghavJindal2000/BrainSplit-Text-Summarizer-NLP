  ...
  render() {
    return (
      <div className="container">
        <div className="row">
          <div id="abc" className="offset-md-2 col-md-8">
          <center><label style={{ fontSize: "64px", fontWeight: 500  }}>SPLIT BRAIN</label>
          <label style={{ fontSize: "48px", fontWeight: 500  }}>Keyword Summarizer</label></center>
